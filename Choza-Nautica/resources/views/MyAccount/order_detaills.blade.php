        ...
        <div class="card-body">
            ...
            <article class="card">
                <div class="card-body row">
                    ...
                    <div class="col"> <strong>Dirección :</strong> <br> </i>{{$compra->direccion}}, | <i class="fa fa-phone"></i>{{Auth::user()->cliente->celular}}</div>
                    <div class="col"> <strong>Estado Pago:</strong> <br> {{$compra->estado_pago}} </div>
                    <div class="col"> <strong>Código de verificación:</strong> <br> {{$compra->codigo}} </div>
                </div>
            </article>
            <div class="track">
                @if ($compra->estado == 'PENDIENTE')
                    <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Pendiente</span></div>
                    <div class="step"> <span class="icon"> <i class="fa fa-user"></i> </span> <span class="text">Aprovado</span> </div>
                ...
                @elseif ($compra->estado == 'VÁLIDO')
                    <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Pendiente</span> </div>
                    <div class="step active"> <span class="icon"> <i class="fa fa-user"></i> </span> <span class="text">Aprovado</span> </div>
                    <div class="step"> <span class="icon"> <i class="fa fa-truck"></i> </span> <span class="text">En Camino</span> </div>
                    <div class="step"> <span class="icon"> <i class="fa fa-archive"></i> </span> <span class="text">Entregado</span> </div>
                @elseif ($compra->estado == 'EN CAMINO')
                    <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Pendiente</span> </div>
                    <div class="step active"> <span class="icon"> <i class="fa fa-user"></i> </span> <span class="text">Aprovado</span> </div>
                ...
                @elseif ($compra->estado == 'ENTREGADO')
                    ...
                    <div class="step active"> <span class="icon"> <i class="fa fa-user"></i> </span> <span class="text">Aprovado</span> </div>
                    <div class="step active"> <span class="icon"> <i class="fa fa-truck"></i> </span> <span class="text">En Camino</span> </div>
                    <div class="step active"> <span class="icon"> <i class="fa fa-archive"></i> </span> <span class="text">Entregado</span> </div>
                @endif
